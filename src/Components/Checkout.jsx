      ...
      <div className="my-2 py-6 flex flex-col">
        ...
        <div className="w-9/12 m-auto">
          <div className="flex justify-between">
            ...
            <input type="text" name="house-no"  placeholder="Enter House No...." className="indent-2" required/>
          </div>
          <br />
          <div className="flex justify-between">
            <label htmlFor="address">Address :- </label>
            <input type="text" name="address" placeholder="Enter Address" className="indent-2" required />
          </div>
          <br />
          <div className="flex justify-between">
            <label htmlFor="city">City :- </label>
            <input type="text" name="city" placeholder="Enter City" className="indent-2" required/>
          </div>
        </div>
        <br />
